...
class DeitiesDnD extends StatefulWidget {
  ...
  const DeitiesDnD({this.filtroPartida, Key? key}) : super(key: key);

  @override
  _DeitiesDnDState createState() => _DeitiesDnDState();
}

class _DeitiesDnDState extends State<DeitiesDnD> {
  String _searchTerm = '';
      ...
      setState(() {
        ...
        if (_mostrarListado == null) {
          _mostrarListado = _mostrarContenidoGlobal
              ...
              : filtrarContenidoUser('deities', idSesion!);
        }
                                      ...
                                      child: FadeInAnimation(
                                        child: GestureDetector(
                                          onTap: () {
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (BuildContext context) => DeitiesId(id: registro['id'],)
                                              ),
                                            );
                                          },
                                          child: MostrarCampo(
