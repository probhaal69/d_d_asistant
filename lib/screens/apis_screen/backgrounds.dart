...
class _BackgroundsDnDState extends State<BackgroundsDnD> {
  String _searchTerm = '';
      ...
      setState(() {
        ...
        if (_mostrarListado == null) {
          _mostrarListado = _mostrarContenidoGlobal
              ...
              : filtrarContenidoUser('backgrounds', idSesion!);
        }
                                  ...
                                  child: FadeInAnimation(
                                    child: GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (BuildContext context) => BackgroundsId(id: registro['id']),
                                          ),
                                        );
                                      },
                                      child: MostrarCampo(
