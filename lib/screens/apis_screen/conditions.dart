...
class _ConditionsDiseasesDnDState extends State<ConditionsDiseasesDnD> {
  String _searchTerm = '';
  ...
  Future<void> _loadUserId() async {
      ...
      setState(() {
        ...
        if (_mostrarListado == null) {
          _mostrarListado = _mostrarContenidoGlobal
              ? conectarDnDapi('conditionsdiseases')
              : filtrarContenidoUser('conditionsdiseases', idSesion!);
        }
    ...
    if (widget.filtroPartida != null) {
      _mostrarListado = filtrarContenidoPartida('conditionsdiseases', widget.filtroPartida);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Condiciones y enfermedades"),
        leading: IconButton(
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (BuildContext context) => const PartidasJugador(tabla: 'conditionsdiseases'),
                                  ),
                                );
                              },
                                  ...
                                  child: FadeInAnimation(
                                    child: GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (BuildContext context) => ConditionsDiseasesId(id: registro['id']),
                                          ),
                                        );
                                      },
                                      child: MostrarCampo(
