...
class ObjectsDnD extends StatefulWidget {
  ...
  const ObjectsDnD({this.filtroPartida, Key? key}) : super(key: key);
...
class _ObjectsDnDState extends State<ObjectsDnD> {
  ...
  Future<void> _loadUserId() async {
    ...
    if (widget.filtroPartida != null) {
      _mostrarListado = filtrarContenidoPartida('objects', widget.filtroPartida);
    }
  }
                            ...
                            ElevatedButton(
                              onPressed: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (BuildContext context) => const PartidasJugador(tabla: 'objects'),
                                  ),
                                );
                              },
